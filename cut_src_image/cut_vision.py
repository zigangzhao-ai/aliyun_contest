...
src_img_dir = "./data/image"
src_xml_dir = "./data/xml"
dst_img_dir = "./data/image-crop"
dst_xml_dir = "./data/xml-crop"
...
for img in img_name:
    ...
    img1 = cv2.rectangle(im,(x01,y01),(x02,y02),(255,0,0),8)
    plt.imshow(img1)
    plt.show()
    ...
    cv2.imwrite(dst_img_dir + '/' + img + '.jpg',img2)
